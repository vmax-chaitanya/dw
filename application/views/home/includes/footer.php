            ...
            <div class="site-footer__top-inner">
                <div class="site-footer__top-left" style="margin-left: -45px !important;">
                    <div class="site-footer__top-logo">
                        <a href="index.html"><img src="assets/images/resources/logo-1.png" alt height="100" width="250"
                    ...
                    <div class="site-footer__top-title-box">
                        <h3 class="site-footer__top-title">Let's
                            work together just drop me a line - <a
                                href="mailto:info@digitalwinbusinessagency">info@digitalwinbusinessagency</a></h3>
                    </div>
                </div>
                <div class="site-footer__top-right">
                    <div class="site-footer__top-right-social">
                        <a href="https://twitter.com/Digitalwin2023"><i class="fab fa-twitter"></i></a>
                        <a href="https://www.facebook.com/Digitalwinbusinessagency?mibextid=ZbWKwL"><i
                                class="fab fa-facebook"></i></a>
                        <a href="#"><i class="fab fa-pinterest-p"></i></a>
                        <a href="https://instagram.com/digitalwinbusinessagency?igshid=MmU2YjMzNjRlOQ=="><i
                                class="fab fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/in/digitalwin-business-agency-b73a77279/"><i
        ...
        <div class="container">
            <div class="site-footer__middle-inner">
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        <div class="footer-widget__column footer-widget__explore clearfix">
                            <h3 class="footer-widget__title">Other
                                Training</h3>
                            <ul class="footer-widget__explore-list list-unstyled clearfix">
                                <!-- <li><a href="services.html">What We
                                                Offer</a></li> -->

						...
						<div class="service-details__sidebar">
							<div class="service-details__sidebar-service">
								<ul class="service-details__sidebar-service-list list-unstyled">
									<li class="current"><a href="mobile-applications.html">Mobile Applications <span
												class="icon-right-arrow"></span></a></li>
									<li><a href="digital-marketing.html">Digital Marketings <span
												class="icon-right-arrow"></span></a></li>
									<li><a href="graphic-design.html">Graphic Designings <span
												class="icon-right-arrow"></span></a></li>
									<li><a href="website-development.html">Website Developments <span
												class="icon-right-arrow"></span></a></li>
									<li><a href="social-marketing.html">Social Marketings <span
												class="icon-right-arrow"></span></a></li>
									<li><a href="content-writing.html">Content Writtings <span
												class="icon-right-arrow"></span></a></li>
								</ul>
							</div>
					...
					<div class="col-xl-8 col-lg-7">
						<div class="service-details__right">
							...
							<div class="service-details__content">
								<h2 class="service-details__title"><?php echo $training['name']; ?></h2>
							
								<p class="service-details__text-3"><?php echo $training['description']; ?></p>
                                ...
                                <div class="accrodion-grp faq-one-accrodion" data-grp-name="faq-one-accrodion2">
                                    <div class="accrodion">
                                        <div class="accrodion-title">
                                            <h4 class="text-align"><?php echo $curriculum['name']; ?></h4>
                                        </div>
                                        <div class="accrodion-content">
                                            <div class="inner">
                                                <p class="text-align"><?php echo $curriculum['description']; ?>
                                                </p>
                                            </div><!-- /.inner -->
                                        </div>
                                    </div>

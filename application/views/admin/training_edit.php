                        ...
                        <div class="col-12 grid-margin">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="form-sample" method="POST" action="<?php echo site_url('admin/training/update/' . $training['id']); ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="name" value="<?php echo set_value('name', $training['name']); ?>" required>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" class="form-control" name="duration" value="<?php echo set_value('duration', $training['duration']); ?>" required>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" name="description" rows="4" required><?php echo set_value('description', $training['description']); ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type="hidden" name="old_image" value="<?php echo $training['image']; ?>" />
                                                <input type="hidden" name="old_brochure" value="<?php echo $training['brochure']; ?>" />

                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <textarea class="form-control" name="description" rows="4" required><?php echo $service_card['description']; ?></textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="number" class="form-control" name="created_by" value="<?php echo $service_card['created_by']; ?>" required>
